...
namespace ZTImage.Reflection.Reflector
{
    ...
    public class ZTReflector : ILoadMember
    {
        ...
        /// <summary> 字段集合
        /// </summary>
        public ObjectPropertyCollection Fields { get; private set; }
        ...
        public static LiteracyNewObject CreateNewObject(Type type, Type[] argTypes = null)
        {
            ...
            {
                dm = new DynamicMethod("", type, Types_Objects);
            }
            else
            {
                dm=new DynamicMethod("", Type_Object, Types_Objects, type);
            }
        ...
        /// </summary>
        public static ZTGetter CreateGetter(PropertyInfo prop)
        {
            if (prop == null)
            {
                return null;
            ...
            il.Emit(OpCodes.Ret);
            return (ZTGetter)dm.CreateDelegate(typeof(ZTGetter));
        }
        /// <summary> IL构造一个用于获取对象字段值的委托
        /// </summary>
        public static ZTGetter CreateGetter(FieldInfo field)
        {
            if (field == null)
            {
                return null;
