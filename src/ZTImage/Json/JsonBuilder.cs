...
namespace ZTImage.Json
{
    ...
    public class JsonBuilder:IDisposable
    {
        ...
        public void AppendTo(string key, IConvertible value)
        {
            if (firstTag)
            {
                Buffer.Append(Comma);
        ...
        public void AppendTo(string key, string value)
        {
            if (firstTag)
            {
                Buffer.Append(Comma);
        ...
        /// <param name="key"></param>
        /// <param name="value"></param>
        public void AppendTo(string key, bool value)
        {
            if (firstTag)
            {
                Buffer.Append(Comma);
        ...
        /// <param name="key"></param>
        /// <param name="value"></param>
        public void AppendTo(string key, object value)
        {
            if (firstTag)
            {
                Buffer.Append(Comma);
        ...
        /// <param name="key"></param>
        /// <param name="value"></param>
        public void AppendTo(string key, DateTime value)
        {
            if (firstTag)
            {
                Buffer.Append(Comma);
        ...
        /// <param name="key"></param>
        /// <param name="value"></param>
        public void AppendTo(string key, IDictionary<string, Object> value)
        {
            if (firstTag)
            {
                Buffer.Append(Comma);
            ...
            while (em.MoveNext())
            {
                AppendKey(em.Current.Key + "", true);
                Buffer.Append(Comma);
                AppendObject(em.Current.Value);
            }
        ...
        /// <param name="key"></param>
        /// <param name="value"></param>
        public void AppendTo(string key, IEnumerable value)
        {
            if (firstTag)
            {
                Buffer.Append(Comma);
